    ...
    const inner = (
      <>
        <p className="font-sans text-[11px] uppercase tracking-[0.22em] font-semibold text-gold mb-5">
          {essay.is_pete_pick ? "Staff pick" : "Latest essay"}
        </p>
...
export function EssayMini({ essay, linkTo, variant = "card", testIdPrefix = "mini-essay" }) {
  ...
  const body = (
    <>
      {essay.is_pete_pick && (
        <p className="font-sans text-[10px] uppercase tracking-wider text-gold font-semibold mb-2">Staff pick</p>
      )}
