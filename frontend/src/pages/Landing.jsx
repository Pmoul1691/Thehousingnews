...
export default function Landing() {
  ...
  return (
    <div data-testid="landing-page">
      {/* Hero */}
      <section className="container-prose pt-24 pb-16 sm:pt-32 sm:pb-24 animate-fade-up">
        <div className="mb-10"><BloomMark size={86} /></div>
        <p data-testid="landing-eyebrow" className="uppercase-label mb-6">A private feed for real estate operators</p>
        <h1 data-testid="landing-headline" className="font-display font-semibold tracking-tight text-4xl sm:text-5xl lg:text-6xl ink leading-[1.05]">
          Two release windows a day. <br className="hidden sm:block" />The rest is quiet.
        </h1>
        ...
        <div className="mt-12 flex flex-wrap items-center gap-4">
          ...
          <Link to="/public" data-testid="hero-public-feed-btn" className="font-sans text-sm font-medium ink hover:text-gold transition-colors underline underline-offset-4 decoration-gold-mid">
      ...
      <section className="border-t hairline">
        <div className="container-prose py-20">
          ...
          <h2 className="font-display font-semibold text-2xl sm:text-3xl ink mb-8">A calm-by-design place to think out loud.</h2>
      ...
      <section className="border-t hairline">
        <div className="container-prose py-20">
          ...
          <h2 className="font-display font-semibold text-2xl sm:text-3xl ink mb-8">Pete Moulton.</h2>
          <div className="prose-serif text-base sm:text-lg leading-relaxed space-y-5 ink">
